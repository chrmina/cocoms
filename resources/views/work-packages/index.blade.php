                            ...
                            <tbody>
                                @foreach ($workPackages as $wp)
                                    <tr class="bg-white border-b hover:bg-gray-50">
                                        <td class="px-6 py-4 font-medium text-gray-900"><a href="{{ route('work-packages.show', $wp) }}" class="text-blue-600 hover:underline">{{ $wp->name }}</a></td>
                                        ...
                                        <td class="px-6 py-4 flex gap-2">
                                            @can('update', $wp)
                                                <a href="{{ route('work-packages.edit', $wp) }}" class="inline-flex items-center px-3 py-1.5 text-xs font-medium text-white bg-green-600 rounded-full hover:bg-green-700 transition-colors">E</a>
                                            @endcan
                                            @can('delete', $wp)
