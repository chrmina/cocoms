...
<h1 class="page-header">New Recipient Form</h1>
<div class="panel panel-default">
  <div class="panel-heading">
    <h3 class="panel-title">Please fill the form to add a new recipient.</h3>
  </div>
  <div class="panel-body">
    <div class="recipient form">
      <div class="col-md-6">
        <?php
        echo $this->Form->create($recipient);
      ...
      <div class="col-md-12 text-center">
        <div class="form-group">
          <?= $this->Form->button(__('Add New Recipient'), ['class' => 'btn btn-default']) ?>
        </div>
        <?= $this->Form->end() ?>
      </div>
    </div>
