...
<h1 class="page-header">New Letter Form</h1>
<div class="panel panel-default">
  <div class="panel-heading">
    <h3 class="panel-title">Please fill the form to add a new letter</h3>
  </div>
    ...
    <div class="letters form">
      ...
      <div class="col-md-12 text-center">
        <div class="form-group">
          <?= $this->Form->button(__('Add New Letter'), ['class' => 'btn btn-default']) ?>
        </div>
        <?= $this->Form->end() ?>
      </div>
    </div>
...
var letters = new Bloodhound({
  ...
  prefetch: {
    ...
    //The output should be: url: '/cocos/letters.json',
