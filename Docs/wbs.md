...
[Home](home.md) | [Usage](usage.md) | [Access Control](accesscontrol.md) | WBS

## What is WBS and WP?
In designing CoCoMS, we assumed that the construction project is organized in work packages (WP) following the [Work Breakdown Structure](https://en.wikipedia.org/wiki/Work_breakdown_structure) (WBS) method.
